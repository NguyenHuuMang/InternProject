...
const Cart = () => {
  return (
    <>
     ...
     <Container classN1="cart-wrapper home-wrapper-2 py-5">
            <div className="row">
                <div className="col-12">
                    ...
                    <div className="cart-data py-3 mb-2 d-flex justify-content-between align-items-center align-content-center">
